...
gku34 rev0.3 のビルドガイドです。 (rev0.2との変更点は [Lofree スイッチ](https://www.lofree.co/products/lofree-x-kailh-full-pom-low-profile-switches)を使えるようにした点のみ)
...
| 3   | トッププレート        | 1枚         | JLCPCBで製造してもらった3Dプリント製のトッププレート                                                                                                           |
...
rev0.3 は[Lofree スイッチ](https://www.lofree.co/products/lofree-x-kailh-full-pom-low-profile-switches)も取り付け可能です。
...
* QMK の場合: [tamago324/qmk_firmware](https://github.com/tamago324/qmk_firmware/tree/tamago324_v2/keyboards/tamago324/gku34) の `tamago324` ブランチの `keyboards/tamago324/gku34` にファームウェアがあります。また、バージョンは 0.21系です
